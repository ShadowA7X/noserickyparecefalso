...
var mysack = new sack("<?php echo site_url(); ?>/wp-admin/admin-ajax.php" );    
    ...
    static function admin_menu(){
        add_submenu_page('kaya_theme_options','Sidebar Generator', 'Sidebar Generator', 'manage_options', 'multiple_sidebars', array('sidebar_generator','admin_page'),100);        
        ...
        <div class="wrap">
            ...
            <table class="widefat page" id="sbg_table" style="width:600px;">
                ...
                <?php
                    ...
                    ?>
                    <tr>
                        <td colspan="3"><?php _e( 'No Sidebars defined','lavan') ?></td>
                    </tr>
                    <?php
                }
                ?>
        ...
        <div id="sbg_box" class="postbox " >
            ...
            <div class="inside">
                <div class="sbg_container">
                    ...
                    <p><?php _e( 'Please select the sidebar you would like to display on this page. <strong>Note:</strong> You must first create the sidebar under Appearance > Sidebars.','lavan') ?>
                    </p>
                    <ul>
                    <?php 
                    ...
                    //var_dump($wp_registered_sidebars);        
                        for($i=0;$i<1;$i++){ ?>
                            ...
                            <select name="sidebar_generator[<?php echo $i?>]" style="display: none;">
                                <option value="0"<?php if($selected_sidebar[$i] == ''){ echo " selected";} ?>><?php _e( 'WP Default Sidebar','lavan'); ?></option>
                            <?php
                            $sidebars = sidebar_generator::get_sidebars();
                            if(is_array($sidebars) && !empty($sidebars)){
                                foreach($sidebars as $sidebar){
                            ...
                            <select name="sidebar_generator_replacement[<?php echo $i?>]">
                             <option value="sidebar" <?php if($selected_sidebar_replacement[$i] == ''){ echo " selected";} ?>><?php _e( 'Sidebar','lavan'); ?></option>
                            <?php

...
function portfolio_register() {
	...
	$labels = array(
		...
		'edit_item'		=> __('Edit Post', 'lavan', 'lavan'),
		'new_item'		=> __('New Post Item ', 'lavan', 'lavan'),
		'view_item'		=> __('View Post Item ', 'lavan', 'lavan'),
		'search_items'	=> __('Search ', 'lavan') . ucwords($pf_slug_name) . _x(' Items', 'lavan','lavan'),
		'not_found'		=> __('Nothing found', 'lavan', 'lavan'),
		'not_found_in_trash'	=> __('not_found_in_trash', 'lavan'),
		'parent_item_colon'	=> ''
	);

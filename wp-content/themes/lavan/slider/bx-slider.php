...
$kaya_options=get_option('kayapati');
	...
	//$slide_text_color=get_post_meta($post->ID,'slide_text_color',true) ? get_post_meta($post->ID,'slide_text_color',true) : '#cc0000';
	...
	if( $slider_target_link == '1' ){ $target_link_class='target=_blank';}else{ $target_link_class=""; }
		...
		$kaya_img_height =  ( get_theme_mod('theme_layout_mode') == 'boxed' ) ?  '1160' : '1920';
			...
			//} else{ $slide_text_color = ''; }?>	
				<div class="caption">
					<h3 class="slide_title" style="<?php echo implode('; ', $slide_color_val); ?>"><?php echo the_title(); ?></h3>
						<p style="color:<?php echo $slide_text_color; ?>"><?php // echo $slide_description; 

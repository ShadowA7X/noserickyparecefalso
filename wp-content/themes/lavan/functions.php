...
require_once locate_template('/lib/includes/pf_custom_meta_options.php'); //Model Custom Options
require_once locate_template('/lib/functions/advance-search.php');
...
//lavan Theme setup
add_action( 'after_setup_theme', 'kaya_lavan_theme_setup' );

function kaya_lavan_theme_setup() {
    ...
    'primary' => __( 'Primary Navigation', 'lavan' ),
    'footer' => __( 'Footer Navigation' , 'lavan'),       
    ) );
...
function kaya_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
           ...
           array(
            'name'                  => 'Kaya Lavan Page Widgets', // The plugin name
            'slug'                  => 'kaya-lavan-page-widgets', // The plugin slug (typically the folder name)
            'source'                => get_stylesheet_directory() . '/lib/plugins/kaya-lavan-page-widgets.zip', // The plugin source
...
// End
//require_once (KAYA_FILEPATH . '/lib/admin/options.php'); //Theme Options
...
require_once locate_template('/lib/includes/customizer/theme_customization.php');
...
require_once(KAYA_INCLUDES . '/kaya_admin_settings.php'); //Admin Settings

//Widgets Registration
require_once(KAYA_WIDGETS . '/widgets.php');
// Make theme available for translation
// Translations can be filed in the /languages/ directory
	load_theme_textdomain( 'lavan', get_template_directory(). '/languages' );
	$locale = get_locale();
...
if( class_exists('woocommerce')){
    ...
    function lavan_product_category_class($classes) {
    ...
    add_filter('post_class', 'lavan_product_category_class');
    if ( ! function_exists( 'woocommerce_get_product_thumbnail' ) ) {
        function woocommerce_get_product_thumbnail( $size = 'shop_catalog', $deprecated1 = 0, $deprecated2 = 0 ) {
            ...
            //echo '<img src="'.get_template_directory_uri().'/images/default_images/product.jpg"  alt="" />';
            }
        }
    }
}

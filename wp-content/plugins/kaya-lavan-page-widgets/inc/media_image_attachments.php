<?php
$lavan_custom_options = array(
    'image_custom_description' => array(
        'label'       => __('Custom Description', $lavan_plugin_name),
        'input'       => 'textarea',
        'helps'       => (''),
        'application' => 'image',
        'exclusions'  => array('audio', 'video'),
        'required'    => false,
        //'error_text'  => __('Copyright field required', $lavan_plugin_name)
    ),
    'image_custom_link' => array(
        'label'       => __('Custom link', $lavan_plugin_name),
        'input'       => 'text',
        'helps'       => __('Ex:http://www.google.com', $lavan_plugin_name),
        'application' => 'image',
        'exclusions'  => array('audio', 'video'),
        'required'    => false,
        //'error_text'  => __('Copyright field required', $lavan_plugin_name)
    ...
    'link_new_window' => array(
        'label'       => __('Target', $lavan_plugin_name),
        'input'       => 'select',
        'options' => array(
            '_blank' => __('_blank',$lavan_plugin_name),
            '_self' => __('_self',$lavan_plugin_name)
        ),
        'application' => 'image',
        'exclusions'   => array('audio', 'video')
    )
...
$lavan_media_custom_options = new Kaya_Custom_Media_Options( $lavan_custom_options );
}
?>